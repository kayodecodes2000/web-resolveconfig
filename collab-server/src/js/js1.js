...
form.addEventListener("submit", async function (e) {
  ...
  // FD.append("template_id", "template_dw6n13m");
  // FD.append("user_id", "g9C40xwxDFxlCPG9P");
  // .sendForm(
  //   "service_2dgc3fa",
  ...
  //   "yHBMX4yCStbeXbxgy"
  // start YINKAAAAAA
  // FD.append("service_id", "service_rgu6fql");
  // FD.append("template_id", "template_ktsmgwi");
  // FD.append("user_id", "o9l7x1ZQeEBsIlWao");
  // for yinks
  // .sendForm(
  //   "service_kz7jleq",
  //   "template_bxlzfc7",
